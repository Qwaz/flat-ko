...
?>
			<?php if ( apply_filters( 'show_flat_credits', true ) ) : ?>
				...
				<footer class="site-info" itemscope itemtype="http://schema.org/WPFooter">
					...
					<?php printf( '%1$s %2$s theme by %3$s, modified by %4$s', 'Flat-ko', wp_get_theme()->get( 'Version' ), '<a rel="nofollow" href="'.esc_url( 'https://themeisle.com/themes/flat/' ).'" title="'.esc_attr( 'Flat WordPress Theme' ).'">Themeisle</a>', '<a rel="nofollow" href="'.esc_url( 'https://github.com/Qwaz' ).'">Qwaz</a>' ); ?>
